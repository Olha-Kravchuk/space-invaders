...
class Player(Ship):
    ...
    def healthbar(self, window):
        pygame.draw.rect(window, (255, 0, 0), (self.x, self.y + self.ship_ing.get_height() + 10, self.ship_ing.get_width(), 10))
        pygame.draw.rect(window, (0, 255, 0), (self.x, self.y + self.ship_ing.get_height() + 10, self.ship_ing.get_width() * (self.health/self.mac_health), 10))
...
class Enemy(Ship):
    ...
    def __init__(self, x, y, color, health=100):
        super().__init__(x, y, health)
        self.ship_ing, self.laser_img = self.COLOR_MAP[color]
        self.mask = pygame.mask.from_surface(self.ship_ing)
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0, 0))
        title_label = title_font.render("Press the mouse to begin...", 1, (250, 250, 250))
